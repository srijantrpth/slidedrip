...
const generateFlashcards = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if (!combinedText.trim()) {
            throw new ApiError(400, "No Text could be extracted from the provided files");
        }
        ...
        try {
            ...
            throw new ApiError(503, `AI Service Temporarily Unavailable: ${error.message}. Please try again in a few moments.`);
        }
